...
customElements.define('action-handler-michaels-header-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-michaels-header-card')) {
    return body.querySelector('action-handler-michaels-header-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-michaels-header-card');
